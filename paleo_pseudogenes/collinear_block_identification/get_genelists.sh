...
analysis="i-adhore/with_middle_filtering_level2_false/${species}"
...
### If chromosome level assembly remove scaffolds, otherwise comment following line out (e.g. Amborella):
rm *scaf*
rm *random*
rm *super*
rm chrUn
